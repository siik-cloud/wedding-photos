...
--
-- Uses gen_random_uuid() — a native PostgreSQL 13+ builtin.
-- No extensions required. Works on all modern Supabase projects.
...
-- secret key, which bypasses RLS. RLS acts as a safety net against
-- accidental direct client access with the publishable key.
